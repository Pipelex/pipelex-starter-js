...
const METHODS_DIR = path.join(REPO_ROOT, "methods");
const GENERATED_ROOT = path.join(REPO_ROOT, "src", "generated");

/** The starter-owned staleness sidecar, written beside each lock. Not stamped, not locked. */
const SOURCES_SIDECAR = "sources.json";
...
async function discoverMethods(): Promise<MethodClosure[]> {
